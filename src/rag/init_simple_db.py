"""
Initialisation de la base de connaissances avec sentence-transformers
Alternative à ChromaDB (pas besoin de Rust)
"""
import os
import json
import pickle
...
def init_simple_db():
    """
    Initialise une base de connaissances simple avec sentence-transformers
    """
    print("🔧 Initialisation de la base de connaissances...")
    print("   ↪ Utilisation de sentence-transformers (pas besoin de ChromaDB)")
    ...
    with open(DOCUMENTS_FILE, 'w', encoding='utf-8') as f:
        json.dump(SUPPORT_DOCUMENTS, f, ensure_ascii=False, indent=2)
    print(f"   ✅ Documents sauvegardés: {DOCUMENTS_FILE}")
    ...
    return model, embeddings, SUPPORT_DOCUMENTS
...
def test_search():
    ...
    for query in test_queries:
        ...
        for i, idx in enumerate(top_indices, 1):
            ...
            print(f"      {i}. {doc_id} (similarité: {similarity:.3f})")
